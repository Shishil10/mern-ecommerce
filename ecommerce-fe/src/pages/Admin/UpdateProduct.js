        ...
        <div className="row">
          ...
          <div className="col-md-9">
            ...
            <div className="m-1 w-75">
              <label className="fw-bold">Select Product Catgory</label>
              <Select
                bordered={false}
              ...
              <div className="mb-3">
                <label className="fw-bold">Upload Product Photo</label>
              ...
              <div className="mb-3">
                <label className="fw-bold">Featured Product</label>
                <Select
                  bordered={false}
                  placeholder="Select Featured Status"
                  size="large"
                  className="form-select mb-3"
                  onChange={(value) => setIsFeatured(value === "1")}  // Set isFeatured based on the selected value
              ...
              <div className="mb-3">
                <label className="fw-bold">Product Quantity</label>
                <input
                  type="number"
                  value={quantity}
              ...
              <div className="mb-3">
                <label className="fw-bold">Product Shipping</label>
                <Select
                  bordered={false}
